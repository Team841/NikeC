...
class TunerConstants {
    ...
    static constexpr std::string_view kCANBusName = "canivore2";
...
public:
    ...
    // This needs to be tuned to your individual robot
    static constexpr units::meters_per_second_t kSpeedAt12Volts = 5.04_mps;
...
private:
    ...
    static constexpr int kFrontLeftEncoderId = 4;
    static constexpr units::turn_t kFrontLeftEncoderOffset = 0.31201171875_tr;
    static constexpr bool kFrontLeftSteerMotorInverted = true;
    static constexpr bool kFrontLeftEncoderInverted = false;

    static constexpr units::inch_t kFrontLeftXPos = 10.375_in;
    static constexpr units::inch_t kFrontLeftYPos = 10.375_in;
    ...
    static constexpr units::turn_t kFrontRightEncoderOffset = -0.257568359375_tr;
    static constexpr bool kFrontRightSteerMotorInverted = true;
    static constexpr bool kFrontRightEncoderInverted = false;

    static constexpr units::inch_t kFrontRightXPos = 10.375_in;
    static constexpr units::inch_t kFrontRightYPos = -10.375_in;
    ...
    static constexpr units::turn_t kBackLeftEncoderOffset = 0.2041015625_tr;
    static constexpr bool kBackLeftSteerMotorInverted = true;
    static constexpr bool kBackLeftEncoderInverted = false;

    static constexpr units::inch_t kBackLeftXPos = -10.375_in;
    static constexpr units::inch_t kBackLeftYPos = 10.375_in;
    ...
    static constexpr units::turn_t kBackRightEncoderOffset = 0.40087890625_tr;
    static constexpr bool kBackRightSteerMotorInverted = true;
    static constexpr bool kBackRightEncoderInverted = false;

    static constexpr units::inch_t kBackRightXPos = -10.375_in;
    static constexpr units::inch_t kBackRightYPos = -10.375_in;
